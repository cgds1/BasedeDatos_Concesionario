...
while (True):
    ...
    print("8. Mostrar los premios que ha ganado un carro si participo en un evento o carrera, en caso de ser una carrera, \nmostrar también la posición, los datos del piloto y los pits")
    print("9. Modificar o eliminar registro de cada entidad en la base de datos (Solo administradores).                                                          ")
    print("10. Si se presta uno o varios vehículos a una empresa para una exhibición o evento, \nmostrar una descripción del evento, días de préstamo, y pago por posibles daños")
